<?php if( get_row_layout() == 'p2a_group_alternating_image_text' ): ?>
    <div class="container-fluid site-component-container p2-picture-text-container picture-left">

        <?php while(have_rows('p2a_image_text')) : the_row(); 
